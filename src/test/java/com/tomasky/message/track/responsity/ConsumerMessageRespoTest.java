...
@ActiveProfiles("pro")
public class ConsumerMessageRespoTest {

    @Autowired
    ConsumerMessageRespo consumerMessageRespo;

    @Test
    public void testQuery() {
        System.out.println("consumerMessageRespo test demo");
        consumerMessageRespo.query("");
    }
}
